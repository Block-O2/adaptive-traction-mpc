...
- `linkage/results/mujoco_stage2/nominal_full_cycle.gif`
- `linkage/results/mujoco_stage2/nominal_timeseries.png`
- `linkage/results/mujoco_stage2/fixed_model_mismatch_summary.json`
