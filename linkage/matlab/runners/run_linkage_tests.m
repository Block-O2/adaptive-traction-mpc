...
r3c_test_dir = fullfile(test_root, ...
...
fprintf('R3C SAFETY LAYER TEST DIRECTORY: %s\n', r3c_test_dir);
...
r3c_results = runtests(r3c_test_dir, 'IncludeSubfolders', false);
...
summary.test_directories{end+1} = r3c_test_dir;
