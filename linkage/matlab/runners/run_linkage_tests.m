...
r3b_test_dir = fullfile(test_root, ...
...
fprintf('R3B RECONTACT MARGIN TEST DIRECTORY: %s\n', r3b_test_dir);
...
r3b_results = runtests(r3b_test_dir, 'IncludeSubfolders', false);
...
summary.test_directories{end+1} = r3b_test_dir;
