...
protective_mode_test_dir = fullfile(test_root, ...
    'near_extension_protective_mode');
...
fprintf('NEAR-EXTENSION PROTECTIVE-MODE TEST DIRECTORY: %s\n', ...
    protective_mode_test_dir);
...
protective_mode_results = runtests(protective_mode_test_dir, ...
    'IncludeSubfolders', false);
...
summary.test_directories{end+1} = protective_mode_test_dir;
