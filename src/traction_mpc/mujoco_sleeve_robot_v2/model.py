...
def build_plant_xml(
  ...
  <worldbody>
    ...
    <body name="hip" pos="0 0 {config.hip_height_m:.9g}">
      <joint name="hip_joint" type="hinge" axis="0 -1 0" range="{human.q_min_rad[0]:.12g} {human.q_max_rad[0]:.12g}" armature="0" stiffness="{human.passive_stiffness_nm_rad[0]:.9g}" damping="{human.passive_damping_nms_rad[0]:.9g}" springref="{human.q_rest_rad[0]:.12g}"/>
      ...
      <body name="shank" pos="{human.thigh_length_m:.12g} 0 0">
        <joint name="knee_joint" type="hinge" axis="0 1 0" range="{human.q_min_rad[1]:.12g} {human.q_max_rad[1]:.12g}" armature="0" stiffness="{human.passive_stiffness_nm_rad[1]:.9g}" damping="{human.passive_damping_nms_rad[1]:.9g}" springref="{human.q_rest_rad[1]:.12g}"/>
    ...
    <body name="robot_base" pos="{base_x:.9g} {base_y:.9g} {base_z:.9g}">
      ...
      <body name="robot_link_1">
        <joint name="robot_joint_1" type="hinge" axis="0 0 1" range="{ranges[0][0]:.12g} {ranges[0][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[0]:.9g}"/>
        ...
        <body name="robot_link_2" pos="0 0 {robot.base_column_height_m:.9g}">
          <joint name="robot_joint_2" type="hinge" axis="0 1 0" range="{ranges[1][0]:.12g} {ranges[1][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[1]:.9g}"/>
          ...
          <body name="robot_link_3" pos="{l2:.9g} 0 0">
            <joint name="robot_joint_3" type="hinge" axis="0 1 0" range="{ranges[2][0]:.12g} {ranges[2][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[2]:.9g}"/>
            ...
            <body name="robot_link_4" pos="{l3:.9g} 0 0">
              <joint name="robot_joint_4" type="hinge" axis="1 0 0" range="{ranges[3][0]:.12g} {ranges[3][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[3]:.9g}"/>
              ...
              <body name="robot_link_5" pos="{l4:.9g} 0 0">
                <joint name="robot_joint_5" type="hinge" axis="0 1 0" range="{ranges[4][0]:.12g} {ranges[4][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[4]:.9g}"/>
                ...
                <body name="robot_link_6" pos="{l5:.9g} 0 0">
                  <joint name="robot_joint_6" type="hinge" axis="1 0 0" range="{ranges[5][0]:.12g} {ranges[5][1]:.12g}" armature="0.003" damping="{robot.joint_damping_nms_rad[5]:.9g}"/>
  ...
  <equality>
    <weld name="sleeve_connection" site1="robot_ee_site" site2="sleeve_attach_site" solref="-{config.sleeve_stiffness_n_m:.9g} -{config.sleeve_damping_ns_m:.9g}" solimp="{config.sleeve_solimp_min:.9g} {config.sleeve_solimp_max:.9g} {config.sleeve_solimp_width_m:.9g}"/>{fixture_xml}
  </equality>
  <actuator>
{actuator_xml}
  </actuator>
