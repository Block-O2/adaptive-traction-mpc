...
完整的 11x11 `I`、列归一化 information matrix、全部 singular vectors、block end times 和弱方向保存在 `results/stage4_trajectory_excitation_design_audit/audit.json`；以下表格是同一 artifact 的审阅摘要。
