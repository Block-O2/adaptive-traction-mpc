...
|---|---|---|---|
| Registered adaptive A/B | Causal trusted adaptation improved tracking RMSE 6.85% and torque prediction 10.30%; cuff interaction did not materially improve. | `results/stage4_single_challenger_closed_loop_ab_formal/` | comparison JSON `870d546a...a6b3`; prior/adaptive trace `2ef8e9b9...81b2` / `7dd4da7f...55c70` |
| Realtime replay | Batched MPC 9.422 ms mean and full cycle 16.524 ms mean; >30 Hz supported on the audited desktop replay. | `results/stage4_realtime_implementation_sprint_20260828/` | optimized timing `3ed2fc44...a97` |
| Patient/model mismatch | 13/13 promotion; tracking improved 13/13, prediction 9/13; 10/13 pairs completed, three shared late-qualification incompletion; no recorded safety event. | `results/stage4_patient_mismatch_robustness_formal/` | config `a51d3cb0...129b`; aggregate `fde83874...e4f` |
| Nominal sensor decomposition | For seed 44104, systematic bias+drift—not ideal or noise-only—produced measured-domain trusted compensation and clean-oracle degradation. | `results/stage4_nominal_sensor_decomposition_formal/` | aggregate `77c281cb...b924`; manifest `a165ae7b...0739` |
| Nominal sensor multiseed | Promotion 0/5 ideal, 2/5 noise-only, 5/5 bias+drift; all seven promoted nominal cases improved measured loss while degrading clean-oracle prediction. | `results/stage4_nominal_sensor_multiseed_formal/` | aggregate `01143a08...29b`; manifest `d4dd2cb7...1e01` |
| Trajectory excitation | 5/6 promotion and RMSE benefit; full rank alone was insufficient; poor conditioning delayed usefulness; one shared force-gate negative case retained. | `results/stage4_trajectory_excitation_generalization_formal/` and `results/stage4_trajectory_excitation_generalization_summary/` | trajectory config `3024919e...c14`; offline audit `46e78190...458`; aggregate `27f031cc...90b` |
| Crossed patient × trajectory × seed replication | 18/18 promotion, completion, tracking improvement, and prediction improvement; no recorded safety event; H1/H2/H5 supported, H3/H4 conditional. | `results/stage4_crossed_excitation_replication_formal/` and `results/stage4_crossed_excitation_replication_summary_final/` | matrix `00019282...c81`; final aggregate `14f5ffb9...e922` |
...
fde838741f23db59bd749ee3f85c59e3a230affd743bfa214a86bfc3bca88e4f  results/stage4_patient_mismatch_robustness_formal/aggregate_summary.json
77c281cbf84a9b78b3a945a5033ad5e56281610df1d76919b7ba01a5c368b924  results/stage4_nominal_sensor_decomposition_formal/aggregate_summary.json
01143a08e8793581b06241460e8b8929edb465d4063c7947c6fe3d6eed13b5c8  results/stage4_nominal_sensor_multiseed_formal/aggregate_summary.json
27f031ccba4099f387ee449669686e9b1148181eb4798b91fe610e2f7c44190b  results/stage4_trajectory_excitation_generalization_summary/aggregate_summary.json
14f5ffb94a4d261eade3601f661d46effa910bbbc2c53e7834a27ff85888e922  results/stage4_crossed_excitation_replication_summary_final/aggregate_summary.json
```
...
Run from `stages/stage3_full3d`. Formal experiments are reserved for the user
