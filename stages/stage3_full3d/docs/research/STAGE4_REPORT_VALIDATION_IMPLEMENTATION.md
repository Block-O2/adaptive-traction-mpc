...
PYTHONPATH=src:. conda run -n mpc_learn python \
  ...
  --matrix-config configs/stage4_report_validation_matrix_v2_coupled_pd.json \
  --case-dir results/stage4_report_validation_baseline_formal/nominal_reference__registered_high_flexion_23s \
  --output-dir results/stage4_report_validation_visualization/nominal_high_flexion \
  --fps 8
```
