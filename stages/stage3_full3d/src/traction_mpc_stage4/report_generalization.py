...
def load_generalization_matrix(path: Path) -> dict[str, Any]:
    ...
    validation_path = root / validation_source["path"]
...
def load_metric_definitions(
    ...
    path = report_root(matrix_path) / source["path"]
