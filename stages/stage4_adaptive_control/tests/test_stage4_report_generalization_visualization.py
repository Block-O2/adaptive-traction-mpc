...
STATISTICAL = ROOT / "results/controller_validation/patient_generalization/study"
DEMO = ROOT / "results/controller_validation/trajectory_generalization/demo_sources"
