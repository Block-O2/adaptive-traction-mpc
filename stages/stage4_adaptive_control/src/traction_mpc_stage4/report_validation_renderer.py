...
from .artifact_paths import resolve_manifest_artifact
...
def load_manifest_media_panels(
    *,
    ...
    for item in selected:
        stage_root = report_root(generalization_matrix_path)
        trace_path = resolve_manifest_artifact(stage_root, item["source_trace_path"])
        summary_path = resolve_manifest_artifact(stage_root, item["source_summary_path"])
